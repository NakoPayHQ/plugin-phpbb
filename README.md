...
2. Upload the `nakopay/payments` folder into your phpBB installation's `ext/` directory so the final path is:

   ```
   <phpbb-root>/ext/nakopay/payments/
   ```
...
2. Via SFTP, delete `ext/nakopay/payments/`.
